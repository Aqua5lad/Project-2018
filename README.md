...
This data set recorded the measurements (in centimetres) of 4 variables of each Iris. These were the sepal length, sepal width, petal length and petal width. It was performed on 50 flowers from each of 3 species of Iris, resulting in a total of 600 observations.
